<div class="flex flex-col min-h-screen">
    ...
    <div class="flex flex-col items-center my-16 max-sm:px-4">
        <p class="text-center max-sm:text-sm">Join the email newsletter to stay tuned for updates.</p>
        <form class="flex flex-row max-sm:flex-col max-sm:w-full">
            <input
                class="mt-4 px-4 py-2 bg-inherit font-bold rounded-md border border-solid border-white border-opacity-5"

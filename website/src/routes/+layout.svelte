...
<div class="flex flex-col w-full min-h-screen h-full">
    <div class="flex flex-col items-center w-full">
        <div class="nav-bar flex flex-row items-center justify-between w-full py-12 px-72 bg-[#191B21] border-b border-solid border-white border-opacity-5 max-lg:px-12 max-sm:flex-col max-sm:px-0 max-sm:py-8">
            <a
                class="text-xl"
                href="/"
            >
